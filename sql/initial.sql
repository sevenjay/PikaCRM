...
CREATE TABLE "Event" ("e_id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "c_id" INTEGER NOT NULL, "c_title" CHAR , "e_ask" TEXT NOT NULL , "e_status" CHAR, "e_rtime" DATETIME, "e_ctime" DATETIME NOT NULL  DEFAULT (datetime(CURRENT_TIMESTAMP,'localtime')), "e_note" TEXT);
...
CREATE TABLE "Orders" ("o_id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "c_id" INTEGER NOT NULL, "c_title" CHAR , "o_ship_add" CHAR, "o_bill_add" CHAR, "o_order_date" DATETIME, "o_ship_date" DATETIME, "o_status" CHAR, "o_ctime" DATETIME NOT NULL  DEFAULT (datetime(CURRENT_TIMESTAMP,'localtime')), "o_mtime" DATETIME, "o_note" TEXT);
