...
CREATE TABLE "Event" ("e_id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "c_id" INTEGER NOT NULL , "e_ask" TEXT NOT NULL , "e_status" CHAR, "e_rtime" DATETIME, "e_ctime" DATETIME NOT NULL  DEFAULT CURRENT_TIMESTAMP, "e_note" TEXT);
